...
class Bird(object):
    ...
    def __init__(self):
        ...
        # 定义鸟的3种状态列表
        self.birdStatus = [pygame.image.load("F:/BaiduNetdiskDownload/Pygame相关图片/assets/1.png"),
                           pygame.image.load("F:/BaiduNetdiskDownload/Pygame相关图片/assets/2.png"),
                           pygame.image.load("F:/BaiduNetdiskDownload/Pygame相关图片/assets/dead.png")]
...
class Pipeline(object):
    ...
    def __init__(self):
        ...
        self.pineUp = pygame.image.load("F:/BaiduNetdiskDownload/Pygame相关图片/assets/top.png")
        self.pineDown = pygame.image.load("F:/BaiduNetdiskDownload/Pygame相关图片/assets/bottom.png")
...
if __name__ == '__main__':
    ...
    while True:
        ...
        background = pygame.image.load("F:/BaiduNetdiskDownload/Pygame相关图片/assets/background.png")  # 加载背景图片
